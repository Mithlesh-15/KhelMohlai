    ...
    >
      ...
      >
        {logo ? (
          ...
          <span className="text-sm font-semibold uppercase" style={{ color: 'var(--text-secondary)' }}>
            {name.slice(0, 1)}
          </span>
        )}
      </div>
...
function MatchCard({ match }) {
  ...
  return (
    <Link
      ...
      aria-label={`Open match ${match.team1.name} versus ${match.team2.name}`}
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <MatchTeam align="right" logo={match.team2.logo} name={match.team2.name} />
      </div>
